<?php
    ...
    <head>
        ...
        <meta name='description' content='<?php echo htmlspecialchars("Diggers\/Excavators"); ?>'>
        <meta name='keywords' content='<?php echo htmlspecialchars("Diggers, Mini diggers"); ?>'>
    ...
    <body>
        ...
        <?php if (!empty("uploads\/categories\/1727376430_Digger.jfif")): ?>
            <img src='../../<?php echo htmlspecialchars("uploads\/categories\/1727376430_Digger.jfif"); ?>' alt='<?php echo htmlspecialchars("A large excavator digger"); ?>'>
        <?php endif; ?>

        <p><?php echo htmlspecialchars("Diggers\/Excavators"); ?></p>
