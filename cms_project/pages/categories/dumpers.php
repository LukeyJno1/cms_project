<?php
    ...
    <body>
        ...
        <?php if (!empty("uploads\/categories\/1727376729_Dumper.jfif")): ?>
            <img src='../../<?php echo htmlspecialchars("uploads\/categories\/1727376729_Dumper.jfif"); ?>' alt='<?php echo htmlspecialchars(""); ?>'>
        <?php endif; ?>
