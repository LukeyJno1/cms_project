<?php
    ...
    <body>
        ...
        <?php if (!empty("uploads\/categories\/1727385416_Front Loader.jfif")): ?>
            <img src='../../<?php echo htmlspecialchars("uploads\/categories\/1727385416_Front Loader.jfif"); ?>' alt='<?php echo htmlspecialchars(""); ?>'>
        <?php endif; ?>
