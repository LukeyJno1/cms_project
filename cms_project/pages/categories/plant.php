<?php
    ...
    <head>
        ...
        <meta name='description' content='<?php echo htmlspecialchars("Diggers, Dumpers, Loaders, Mixers, Rollers, Generators etc"); ?>'>
        <meta name='keywords' content='<?php echo htmlspecialchars("Diggers, Dumpers, Loaders, Mixers, Rollers, Generators etc"); ?>'>
    ...
    <body>
        ...
        <?php if (!empty("uploads\/categories\/1727376304_Plant Equipment.jfif")): ?>
            <img src='../../<?php echo htmlspecialchars("uploads\/categories\/1727376304_Plant Equipment.jfif"); ?>' alt='<?php echo htmlspecialchars("Plant Equipment"); ?>'>
        <?php endif; ?>

        <p><?php echo htmlspecialchars("Diggers, Dumpers, Loaders, Mixers, Rollers, Generators etc"); ?></p>
